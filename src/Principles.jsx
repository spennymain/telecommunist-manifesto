...
const q4 = "Was the abolition of private telecommunication not possible at an earlier time?"
const a1 = "Telecommunism is the doctrine of the conditions of the liberation of consumers"
const a2 = `The consumer the working class member of society who depends entirely on a private provider's resources
...
const a4 = `No,	global telecommunications is in its infancy. Only recently did our knowledge and access
to resources allow the Internet to seemlessly connect billions of people on, relatively affordable IoT devices.`
